...
?>
<form method='post' target='_blank' action='data/report/lap_akun_piutang_kartu_kredit.php' id="form_input" style="width:600px">
	...
	<fieldset id="field">
    	...
    	<table width="100%" id="label_laporan">
            <tr>
                <td width="34%"><label id="label_laporan"><input type="radio" name="rdTampil" value="DetailPiutang" checked="checked"> Detail Piutang Kartu Kredit</label></td>
            ...
            <tr>
				<td><label id="label_laporan"><input type="radio" name="rdTampil" value="KartuPiutang"> Kartu Piutang Kartu Kredit</label></td>            	
				<td><label id="label_laporan"><input type="radio" name="rdTampil" value="RekapPelunasanPiutang"/> Rekapitulasi Pelunasan Piutang Kartu Kredit</label></td>				
            </tr>            
            <tr>
                <td><label id="label_laporan"><input type="radio" name="rdTampil" value="RekapPiutang"/> Rekapitulasi Piutang Kartu Kredit</label></td>
