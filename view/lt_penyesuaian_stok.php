...
?>
<form method='post' target='_blank' action='data/report/lap_transaksi_penyesuaian.php' id="form_input" style="width:750px">
	...
	<fieldset id="field">
        ...
        <table width="100%" border="0">
           	<tr>
               	...
               	<td width="36%"><label id="label_laporan"><input type="radio" name="rdTampil" value="RegisterByLokasi"> Register Berdasarkan Lokasi</label></td>
               	<td width="31%"><label id="label_laporan"><input type="radio" name="rdTampil" value="RegisterByBarang"> Register Berdasarkan Barang</label></td>
        	</tr>
		</table>
    </fieldset>
	
	<input type="hidden" name="excel" id="excel">
	<input type="hidden" name="file_name" id="file_name" value="LaporanPenyesuaian">
</form>

<script>
$(document).ready(function(){
	browse_data('#txt_lokasi', 'lokasi','KODE');
