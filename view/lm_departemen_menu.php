...
?>
<form method='post' target='_blank' action='data/report/lap_m_departemen_menu.php' id="form_input" style="width:500px">
    ...
    <table style="border-bottom:1px #000">
    	...
    	<tr>
			<td align="right" id="label_laporan">Departemen Menu :</td>
			<td id="label_laporan"><input id="txt_namadepartemenmenu" name="txt_namadepartemenmenu" class="label_input" style="width:250px" prompt="nama departemen menu">
