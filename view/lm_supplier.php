...
?>
<form method='post' target='_blank' action='data/report/lap_m_supplier.php' id="form_input" style="width:520px">
    ...
    <table style="border-bottom:1px #000" id="label_laporan">
		<tr>
			...
			<td><input class="label_input" id="txt_namasupplier" name="txt_namasupplier" style="width:200px"></td>
		</tr>
    </table>
...
$(document).ready(function(){
	browse_data('#txt_kode_awal', 'supplier');
	browse_data('#txt_kode_akhir', 'supplier');
});
