...
?>
<form method='post' target='_blank' action='data/report/lap_transaksi_barang_rusak.php' id="form_input" style="width:680px">
	...
	<table style="border-bottom:1px #000">
        ...
        <tr>
            <td align="right" id="label_laporan">Gudang Asal :</td>
            <td><input id="txt_gudangasal" name="txt_gudangasal" style="width:250px"/></td>
        </tr>  
        <tr>
            <td align="right" id="label_laporan">Gudang Tujuan :</td>
            <td><input id="txt_gudangtujuan" name="txt_gudangtujuan" style="width:250px"/></td>
        </tr>  
        <tr hidden>
	...
	<input type="hidden" name="file_name" id="file_name" value="LaporanBarangRusak">
</form>
<script>
$(document).ready(function(){
	browse_data_lokasi('#txt_lokasi', 'lokasi','KODE');
	browse_data_gudang('#txt_gudangasal', 'gudang','KODE');
	browse_data_gudang('#txt_gudangtujuan', 'gudang','KODE');
