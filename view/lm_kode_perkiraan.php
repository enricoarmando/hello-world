...
?>
<form method='post' target='_blank' action='data/report/lap_m_kode_perkiraan.php' id="form_input" style="width:520px">
    ...
    <table style="border-bottom:1px #000" id="label_laporan">
		<tr>
			<td align="right" id="label_laporan">Kode Perkiraan :</td>
	...
	<input type="hidden" name="file_name" id="file_name" value="ChartOfAccountReport">
</form>
<script>
$(document).ready(function(){
	browse_data('#txt_kode_awal', 'kode_perkiraan');
	browse_data('#txt_kode_akhir', 'kode_perkiraan');
});
