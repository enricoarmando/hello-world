...
?>
<form method='post' target='_blank' action='data/report/lap_transaksi_pembelian.php' id="form_input" style="width:720px">
    ...
    <fieldset id="field">
        ...
        <table width="100%">
            <tr>
                <td width="30%"><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="BELI" checked="checked"> Beli</label></td>
                <td><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="RETUR BELI" checked="checked"> Retur Beli</label></td>
            </tr>
        </table>
    </fieldset>
	...
	<fieldset id="field" hidden>
        ...
        <table width="100%" border="0">
           	<tr>
               	<td><label id="label_laporan"><input type="checkbox" name="cbJenis[]" value="Beli" checked="checked"> Pembelian</label></td>
				<td><label id="label_laporan"><input type="checkbox" name="cbJenis[]" value="Retur Beli" checked="checked"/> Retur Pembelian</label></td>
        	</tr>
		</table>
    </fieldset>
	...
	<fieldset id="field">
        ...
        <table width="100%" border="0">
           	...
           	<tr>
				...
				<td><label id="label_laporan"><input type="radio" name="rdTampil" value="RekapBySupplier" /> Rekap Berdasar Supplier</label></td>
			</tr>
           	<tr>
               	<td><label id="label_laporan"><input type="radio" name="rdTampil" value="RegisterByBarang"> Register Berdasar Barang</label></td>
				<td>&nbsp;</td>
			</tr>
		</table>
    </fieldset>
	...
	<input type="hidden" name="file_name" id="file_name" value="LaporanPurchase">
</form>
<script>
$(document).ready(function(){
	...
	$('#txt_supplier_awal, #txt_supplier_akhir, #txt_barang_awal, #txt_barang_akhir').combogrid('disable');
});
