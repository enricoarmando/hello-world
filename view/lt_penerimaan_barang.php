...
?>
<form method='post' target='_blank' action='data/report/lap_transaksi_penerimaan.php' id="form_input" style="width:720px">
	...
	<input type="hidden" name="file_name" id="file_name" value="LaporanPenerimaan">
</form>
<script>
