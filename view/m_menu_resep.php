...
$(document).ready(function(){
	...
	$('#form_input').form({
        url:'data/process/proses_master.php?table=simpan_menu_resep&act=insert',
        ajax:true,
        iframe:false,
...
function ubah() {
	...
	if (row) {
		...
		if (gambar && gambar != "") {
			...
			downloadingImage.src = "http://<?=$_SERVER['HTTP_HOST']?>"+url+"gambar-menu/"+gambar+'?'+ new Date().getTime();
