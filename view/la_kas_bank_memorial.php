...
<form method='post' target='_blank' action='data/report/lap_akun_kas.php' id="form_input" style="width:500px">
    ...
    <fieldset id="field">
        ...
        <table width="410" id="label_laporan">
            <tr>
                <td width="50%"><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="KAS MASUK" checked="checked">Kas Masuk</label></td>
                <td width=""><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="KAS KELUAR" checked="checked">Kas Keluar</label></td>
            </tr>
			<tr>
                <td><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="BANK MASUK" checked="checked">Bank Masuk</label></td>
                <td><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="BANK KELUAR" checked="checked">Bank Keluar</label></td>
            </tr>
			<tr>
                <td><label id="label_laporan"><input type="checkbox" class="jtrans" name="cbJenis[]" value="MEMORIAL" disabled>Memorial</label></td>
                <td></td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset id="field">
        ...
        <table width="466" id="label_laporan">
            <tr>
                <!--<td width="43%" hidden><label id="label_laporan"><input type="radio" name="rdTampil" value="Harian" >Harian</label></td>-->
                <td width="33%"><label id="label_laporan"><input type="radio" name="rdTampil" value="Detail" checked="checked">Detail</label></td>
                <td width="33%"><label id="label_laporan"><input type="radio" name="rdTampil" value="Register">Register</label></td>
				<td width="33%"><label id="label_laporan"><input type="radio" name="rdTampil" value="Rekap">Rekap</label></td>
            </tr>
        </table>
    </fieldset>
    <fieldset id="field">
...
$(document).ready(function(){
  ...
  //  $("#txt_tgl_ak").datebox('disable');
	...
	$.ajax({
		type: 'POST',
		dataType: 'json',
		url: "config/combogrid.php?table=kode_perkiraan&jenis=kas_bank",
		data: "",
		cache: false,
...
$("[name=rdTampil]").change(function(){
	if ($(this).val()=="Harian" || $(this).val()=="Detail" || $(this).val()=="Rekap") {
	    if ($(this).val()=="Harian") {
			$("#txt_tgl_ak").datebox('disable');
		} else {
