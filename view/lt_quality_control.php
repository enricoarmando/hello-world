...
?>
<form method='post' target='_blank' action='data/report/lap_transaksi_quality_control.php' id="form_input" style="width:720px">
	...
	<table style="border-bottom:1px #000">
        ...
        <tr hidden>
			<td align="right"><label id="label_laporan"><input type="radio" name="rd_marketing" value="1" checked> Salesman :</label></td>
	...
	<legend id="label_laporan">Jenis Laporan</legend>
        <table width="100%" border="0">
           	<tr>
				...
				<td><label id="label_laporan"><input type="radio" name="rdTampil" value="RekapByFaktur"> Rekap Berdasarkan No Transaksi</label></td>
        	</tr>
		</table>
    </fieldset>

	<input type="hidden" name="excel" id="excel">
	<input type="hidden" name="file_name" id="file_name" value="LaporanQualityControl">
</form>
<script>
