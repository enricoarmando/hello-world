...
?>
<form method='post' target='_blank' action='data/report/lap_transaksi_transfer.php' id="form_input" style="width:680px">
	...
	<input type="hidden" name="file_name" id="file_name" value="TransferReport">
</form>
<script>
