...
?>
<form method='post' target='_blank' action='data/report/lap_m_jurubayar.php' id="form_input" style="width:520px">
    ...
    <table style="border-bottom:1px #000" id="label_laporan">
		<tr>
			...
			<td><input class="label_input" id="txt_namajurubayar" name="txt_namajurubayar" style="width:200px"></td>
		</tr>
		<tr>
	...
	<input type="hidden" name="file_name" id="file_name" value="LaporanJuruBayar">
</form>
<script>
$(document).ready(function(){
	browse_data('#txt_kode_awal', 'juru_bayar');
	browse_data('#txt_kode_akhir', 'juru_bayar');
});
