...
?>
<form method='post' target='_blank' action='data/report/lap_m_promo.php' id="form_input" style="width:520px">
	...
	<input type="hidden" name="file_name" id="file_name" value="LaporanPromo">
</form>
<script>
$(document).ready(function(){
	browse_data('#txt_kode_awal', 'promo');
	browse_data('#txt_kode_akhir', 'promo');
});
